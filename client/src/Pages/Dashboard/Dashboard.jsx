        ...
        <>
            <div className={StylesDashboard.dashboard} style={{ width: '90vw' }}>
                ...
                <div className={StylesDashboard.sideNavBar} style={{ position: 'fixed' }}>
                    ...
                    <div className={activeItem === 'Logout' ? StylesDashboard.activeItem : StylesDashboard.inactiveItem} onClick={onOpenModal} style={{ position: 'relative', bottom: '-35vh', cursor: 'pointer' }}>
